package bcs.aicrm.broadcns.authservice.config.mybatis;
...
public class MybatisConfig {
	...
	public String sqlSessionTypeAliasesPackage() {
		...
		buffer.append("  bcs.aicrm.broadcns.authservice.lgin.model.VO");
		buffer.append(", bcs.aicrm.broadcns.authservice.lgin.model.DTO");
